...
void main() {
  ...
  setUp(() {
    tNumberTriviaModel = NumberTriviaModel(number: 1, text: 'Test');
  });

  tearDown(() {
    tNumberTriviaModel = null;
  });
  test(
  ...
  group(
    ...
    () {
      test(
        ...
        () async {
          ...
          final Map<String, dynamic> jsonMap =
              json.decode(fixture('trivial.json'));
          // act
      ...
      test(
        'should return a valid model when a JSON number is regarded as Double',
        () async {
          // arrange
          final Map<String, dynamic> jsonMap =
              json.decode(fixture('trivial_double.json'));
          // act
          final result = NumberTriviaModel.fromJson(jsonMap);
          // assert
          expect(result, tNumberTriviaModel);
